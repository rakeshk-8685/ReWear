...
export const env = {
  ...
  MONGO_URI: rawMongoUri || (process.env.NODE_ENV === 'production' ? '' : 'mongodb://127.0.0.1:27017/rewear_db'),
  ...
  CLIENT_URL: process.env.CLIENT_URL || process.env.FRONTEND_URL || 'http://localhost:4200',
